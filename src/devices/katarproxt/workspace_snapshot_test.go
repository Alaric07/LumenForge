...
func TestKatarXTWorkspaceSnapshots(t *testing.T) {
	assignments := map[int]inputmanager.KeyAssignment{1: {Name: "Left Button", Default: true}, 2: {Name: "Right Button", Default: true}, 4: {Name: "Middle Button", Default: true}, 8: {Name: "Back Button", ActionType: 10, ActionCommand: 42, IsMacro: true}, 16: {Name: "Forward Button", Default: true}, 32: {Name: "DPI Button", Default: true}}
	d := &Device{Serial: "katar-xt", MinDPI: 100, MaxDPI: 12400, DeviceProfile: &DeviceProfile{Profile: 1, PollingRate: 4, ButtonOptimization: 1, Profiles: map[int]DPIProfile{2: {Name: "Sniper", Value: 400, Color: &rgb.Color{Red: 255, Green: 170}, Sniper: true}, 0: {Value: 800, Color: &rgb.Color{Red: 1, Green: 2, Blue: 3}}, 1: {Name: "Stage 2", Value: 1600, Color: &rgb.Color{Green: 255}}}}, KeyAssignment: assignments, KeyAssignmentTypes: map[int]string{0: "None", 1: "Media", 2: "DPI", 3: "Keyboard", 8: "Sniper", 9: "Mouse", 10: "Macro", 11: "Profile"}, PollingRates: map[int]string{4: "1000", 1: "125", 0: "Not Set"}, SwitchModes: map[int]string{1: "Enabled", 0: "Disabled"}, UserProfiles: map[string]*DeviceProfile{"z": {}, "a": {Active: true}, "nil": nil}}
	...
	if !ok || !reflect.DeepEqual([]int{buttons.Buttons[0].KeyIndex, buttons.Buttons[1].KeyIndex, buttons.Buttons[2].KeyIndex, buttons.Buttons[3].KeyIndex, buttons.Buttons[4].KeyIndex, buttons.Buttons[5].KeyIndex}, katarProXTVisibleButtonOrder) || buttons.Buttons[3].ActionCommand != 42 || len(buttons.AssignmentTypes) != 8 {
