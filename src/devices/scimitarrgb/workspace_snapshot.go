...
var scimitarRGBVisibleButtonOrder = []int{1, 2, 4, 32, 64, 256, 512, 1024, 2048, 4096, 8192, 16384, 32768, 65536, 131072, 262144, 524288}
...
func (d *Device) ButtonsSnapshot() (buttonspresentation.Snapshot, bool) {
	...
	s := buttonspresentation.Snapshot{Buttons: make([]buttonspresentation.Button, 0, len(scimitarRGBVisibleButtonOrder))}
...
func scimitarRGBOptions(v map[int]string) []performancepresentation.Option {
...
func (d *Device) PerformanceSnapshot() (performancepresentation.Snapshot, bool) {
	...
	p, l := scimitarRGBOptions(d.PollingRates), scimitarRGBOptions(d.LiftHeights)
	if p == nil || l == nil {
		return performancepresentation.Snapshot{}, false
	}
