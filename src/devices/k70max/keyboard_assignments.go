...
func (d *Device) KeyboardAssignmentsSnapshot() (keyboardassignmentspresentation.Snapshot, bool) {
	if d == nil || d.DeviceProfile == nil || d.DeviceProfile.Profile == "" || len(d.Layouts) == 0 || d.UIKeyboard == "" || d.UIKeyboardRow == "" || len(d.KeyAssignmentTypes) == 0 || !hasK70Max(d.Layouts, d.DeviceProfile.Layout) || !hasK70Max(d.DeviceProfile.Profiles, d.DeviceProfile.Profile) {
	...
	modifierIDs := make([]int, 0, len(options))
...
func hasK70Max(values []string, value string) bool {
