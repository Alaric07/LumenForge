...
var (
	...
	keyboardKey             = "k70rgbRF-default"
	defaultLayout           = "k70rgbRF-default-US"
...
func (d *Device) createDevice() {
	d.instance = &common.Device{
		ProductType: common.ProductTypeK70RgbRF,
		Product:     d.Product,
		Serial:      d.Serial,
		Firmware:    d.Firmware,
