...
func TestKeyboardAssignmentsSnapshotK70RGBRF(t *testing.T) {
...
func TestKeyboardAssignmentsSnapshotK70RGBRFFailsClosedForInvalidProfileMembership(t *testing.T) {
