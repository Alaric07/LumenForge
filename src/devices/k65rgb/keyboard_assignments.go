...
// KeyboardAssignmentsSnapshot is a read-only, capability-driven view of the
// active persisted keyboard profile. Assignment mutation remains package-owned.
func (d *Device) KeyboardAssignmentsSnapshot() (keyboardassignmentspresentation.Snapshot, bool) {
	if d == nil || d.DeviceProfile == nil || d.DeviceProfile.Profile == "" || len(d.Layouts) == 0 || d.UIKeyboard == "" || d.UIKeyboardRow == "" || len(d.KeyAssignmentTypes) == 0 || !containsK65RGBKeyboardLayout(d.Layouts, d.DeviceProfile.Layout) || !containsK65RGBKeyboardProfile(d.DeviceProfile.Profiles, d.DeviceProfile.Profile) {
...
func containsK65RGBKeyboardLayout(layouts []string, active string) bool {
...
func containsK65RGBKeyboardProfile(profiles []string, active string) bool {
