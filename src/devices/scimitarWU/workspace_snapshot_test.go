...
func scimitarWUWorkspaceDevice() *Device {
...
func TestScimitarWUWorkspaceSnapshotShapeAndCapabilities(t *testing.T) {
	d := scimitarWUWorkspaceDevice()
...
func TestScimitarWUWorkspaceSnapshotsFailClosed(t *testing.T) {
