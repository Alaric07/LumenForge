...
func scimitarWWorkspaceDevice() *Device {
...
func TestScimitarWWorkspaceSnapshotShapeAndCapabilities(t *testing.T) {
	d := scimitarWWorkspaceDevice()
...
func TestScimitarWWorkspaceSnapshotsFailClosed(t *testing.T) {
