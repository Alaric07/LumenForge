...
func TestK55ProModernWorkspaceSnapshotsFailClosed(t *testing.T) {
	keyboard := &keyboards.Keyboard{Row: map[int]keyboards.Row{0: {Keys: map[int]keyboards.Key{1: {KeyName: "A", KeyData: []uint16{99}}}}}}
	assignments := map[int]string{0: "None", 1: "Media Keys", 3: "Keyboard", 8: "Sniper", 9: "Mouse", 10: "Macro"}
	...
	if err != nil || strings.Contains(strings.ToLower(string(encoded)), "keydata") {
