...
func vanguard96WorkspaceDevice() *Device {
	keyboard := &keyboards.Keyboard{Key: keyboardKey, Layout: "US", Row: map[int]keyboards.Row{0: {Keys: map[int]keyboards.Key{4: {KeyName: "A", KeyData: []uint16{4}}, 7: {KeyName: "D", KeyData: []uint16{7}}, 130: {KeyName: "Fn", KeyData: []uint16{130}, Modifier: true}}}}}
