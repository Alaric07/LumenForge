...
func (d *Device) KeyboardAssignmentsSnapshot() (keyboardassignmentspresentation.Snapshot, bool) {
	if d == nil || d.DeviceProfile == nil || d.DeviceProfile.Profile == "" || len(d.Layouts) == 0 || d.UIKeyboard == "" || d.UIKeyboardRow == "" || len(d.KeyAssignmentTypes) == 0 || !vanguard96Contains(d.Layouts, d.DeviceProfile.Layout) || !vanguard96Contains(d.DeviceProfile.Profiles, d.DeviceProfile.Profile) {
...
func vanguard96Contains(values []string, value string) bool {
