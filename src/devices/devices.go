...
import (
	...
	"LumenForge/src/devices/darkcorergbseWU"
	"LumenForge/src/devices/darkcorergbsesongle"
	"LumenForge/src/devices/darkstarWU"
	"LumenForge/src/devices/elite"
	"LumenForge/src/devices/glaivergb"
	"LumenForge/src/devices/glaivergbpro"
	"LumenForge/src/devices/harpoonWU"
	"LumenForge/src/devices/harpoonrgbpro"
	"LumenForge/src/devices/headsetdongle"
	"LumenForge/src/devices/hs80maxdongle"
	"LumenForge/src/devices/hs80rgb"
	"LumenForge/src/devices/hs80rgbWU"
	"LumenForge/src/devices/hydro"
	"LumenForge/src/devices/ironclaw"
	...
	"LumenForge/src/devices/k65plusWdongle"
	...
	"LumenForge/src/devices/katarpro"
	...
	"LumenForge/src/devices/m55"
	"LumenForge/src/devices/m55rgbpro"
	"LumenForge/src/devices/m65prorgb"
	"LumenForge/src/devices/m65rgbelite"
	"LumenForge/src/devices/m65rgbultra"
	"LumenForge/src/devices/m65rgbultraWU"
	"LumenForge/src/devices/m75"
	"LumenForge/src/devices/m75AirWU"
	"LumenForge/src/devices/m75WU"
	"LumenForge/src/devices/makr75WU"
	"LumenForge/src/devices/memory"
	"LumenForge/src/devices/mm700"
	"LumenForge/src/devices/mm800"
	"LumenForge/src/devices/motherboard"
	"LumenForge/src/devices/nautilusLcd"
	"LumenForge/src/devices/nexus"
	...
	"LumenForge/src/devices/sabreprocs"
	"LumenForge/src/devices/sabrergbpro"
	"LumenForge/src/devices/sabrergbproWU"
	"LumenForge/src/devices/sabrev2proWU"
	"LumenForge/src/devices/sabrev2prodongle"
	"LumenForge/src/devices/scimitar"
	"LumenForge/src/devices/scimitarSEWU"
	"LumenForge/src/devices/scimitarWU"
	"LumenForge/src/devices/scimitarprorgb"
	"LumenForge/src/devices/scimitarrgb"
	"LumenForge/src/devices/scimitarrgbelite"
	"LumenForge/src/devices/scufdongle"
	"LumenForge/src/devices/scufdongleV2"
	"LumenForge/src/devices/scufenvisionproV2WU"
	"LumenForge/src/devices/scufenvisionproWU"
	"LumenForge/src/devices/slipstream"
	"LumenForge/src/devices/slipstreamV2"
	"LumenForge/src/devices/st100"
	...
	"LumenForge/src/devices/virtuosomaxdongle"
	"LumenForge/src/devices/virtuosorgbXTWU"
	"LumenForge/src/devices/voidV2dongle"
	"LumenForge/src/devices/voidelitedongle"
...
var deviceRegisterMap = map[uint16]Product{
	...
	11043: {1, 0, "K65 PLUS WIRELESS", k65plusWU.Init, nil},                // K65 PLUS WIRELESS USB
