...
func scimitarSEWUWorkspaceDevice() *Device {
	profile := &DeviceProfile{Active: true, Profile: 0, SleepMode: 15, AngleSnapping: 1, ButtonOptimization: 1, PollingRate: 1, LiftHeight: 2, Profiles: map[int]DPIProfile{0: {Name: "Stage 1", Value: 800, Color: &rgb.Color{Red: 1, Green: 2, Blue: 3}}, 1: {Name: "Sniper", Value: 400, Color: &rgb.Color{Red: 1, Green: 2, Blue: 3}, Sniper: true}}}
...
func TestScimitarSEWUWorkspaceSnapshotShapeAndCapabilities(t *testing.T) {
	d := scimitarSEWUWorkspaceDevice()
	...
	if !ok || (performance.PollingRate != nil) != true || (performance.LiftHeight != nil) != true || performance.ButtonOptimization == nil || performance.AngleSnapping == nil {
...
func TestScimitarSEWUWorkspaceSnapshotsFailClosed(t *testing.T) {
