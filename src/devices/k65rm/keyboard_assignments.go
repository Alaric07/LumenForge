...
func (d *Device) KeyboardAssignmentsSnapshot() (keyboardassignmentspresentation.Snapshot, bool) {
	if d == nil || d.DeviceProfile == nil || d.DeviceProfile.Profile == "" || len(d.Layouts) == 0 || d.UIKeyboard == "" || d.UIKeyboardRow == "" || len(d.KeyAssignmentTypes) == 0 || !k65RMContains(d.Layouts, d.DeviceProfile.Layout) || !k65RMContains(d.DeviceProfile.Profiles, d.DeviceProfile.Profile) {
...
func k65RMContains(values []string, value string) bool {
