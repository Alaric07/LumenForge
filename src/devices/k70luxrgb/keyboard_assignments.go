...
func (d *Device) KeyboardAssignmentsSnapshot() (keyboardassignmentspresentation.Snapshot, bool) {
	if d == nil || d.DeviceProfile == nil || d.DeviceProfile.Profile == "" || len(d.Layouts) == 0 || d.UIKeyboard == "" || d.UIKeyboardRow == "" || len(d.KeyAssignmentTypes) == 0 || !containsK70LUXRGBKeyboardLayout(d.Layouts, d.DeviceProfile.Layout) || !containsK70LUXRGBKeyboardProfile(d.DeviceProfile.Profiles, d.DeviceProfile.Profile) {
...
func containsK70LUXRGBKeyboardLayout(layouts []string, active string) bool {
...
func containsK70LUXRGBKeyboardProfile(profiles []string, active string) bool {
