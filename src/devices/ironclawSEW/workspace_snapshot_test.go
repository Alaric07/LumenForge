...
func ironclawSEWWorkspaceDevice() *Device {
	profile := &DeviceProfile{Active: true, Profile: 0, SleepMode: 15, AngleSnapping: 1, ButtonOptimization: 1, LiftHeight: 2, Profiles: map[int]DPIProfile{0: {Name: "Stage 1", Value: 800}, 1: {Name: "Sniper", Value: 400, Sniper: true}}, DPIColor: &rgb.Color{Red: 1, Green: 2, Blue: 3}}
...
func TestIronclawSEWWorkspaceSnapshotShapeAndCapabilities(t *testing.T) {
	d := ironclawSEWWorkspaceDevice()
...
func TestIronclawSEWWorkspaceSnapshotsFailClosed(t *testing.T) {
