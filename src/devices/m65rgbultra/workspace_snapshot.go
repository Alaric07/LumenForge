...
var m65RGBUltraVisibleButtonOrder = []int{1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048}
...
func (d *Device) ButtonsSnapshot() (buttonspresentation.Snapshot, bool) {
	...
	s := buttonspresentation.Snapshot{Buttons: make([]buttonspresentation.Button, 0, len(m65RGBUltraVisibleButtonOrder))}
...
func m65RGBUltraOptions(v map[int]string) []performancepresentation.Option {
...
func (d *Device) PerformanceSnapshot() (performancepresentation.Snapshot, bool) {
	...
	p, b, l := m65RGBUltraOptions(d.PollingRates), m65RGBUltraOptions(d.SwitchModes), m65RGBUltraOptions(d.LiftHeights)
	if p == nil || b == nil || l == nil {
		return performancepresentation.Snapshot{}, false
	}
	return performancepresentation.Snapshot{PollingRate: &performancepresentation.SelectSetting{Value: d.DeviceProfile.PollingRate, Options: p}, ButtonOptimization: &performancepresentation.SelectSetting{Value: d.DeviceProfile.ButtonOptimization, Options: b}, AngleSnapping: &performancepresentation.ToggleSetting{Enabled: d.DeviceProfile.AngleSnapping == 1}, LiftHeight: &performancepresentation.SelectSetting{Value: d.DeviceProfile.LiftHeight, Options: l}}, true
}
