...
func sabrev2proWWorkspaceDevice() *Device {
	profile := &DeviceProfile{Active: true, Profile: 0, SleepMode: 15, AngleSnapping: 1, LiftHeight: 2, Profiles: map[int]DPIProfile{0: {Name: "Stage 1", Value: 800, Color: &rgb.Color{Red: 1, Green: 2, Blue: 3}}, 1: {Name: "Sniper", Value: 400, Color: &rgb.Color{Red: 4, Green: 5, Blue: 6}, Sniper: true}}}
...
func TestSabrev2proWWorkspaceSnapshotShape(t *testing.T) {
	d := sabrev2proWWorkspaceDevice()
...
func TestSabrev2proWWorkspaceFailsClosed(t *testing.T) {
