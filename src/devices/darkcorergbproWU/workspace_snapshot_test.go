...
func darkcorergbproWUWorkspaceDevice() *Device {
...
func TestDarkcorergbproWUWorkspaceSnapshotShape(t *testing.T) {
	d := darkcorergbproWUWorkspaceDevice()
...
func TestDarkcorergbproWUWorkspaceFailsClosed(t *testing.T) {
