...
func (d *Device) KeyboardAssignmentsSnapshot() (keyboardassignmentspresentation.Snapshot, bool) {
	if d == nil || d.DeviceProfile == nil || d.DeviceProfile.Profile == "" || len(d.Layouts) == 0 || d.UIKeyboard == "" || d.UIKeyboardRow == "" || len(d.KeyAssignmentTypes) == 0 || !containsK70MK2KeyboardLayout(d.Layouts, d.DeviceProfile.Layout) || !containsK70MK2KeyboardProfile(d.DeviceProfile.Profiles, d.DeviceProfile.Profile) {
...
func containsK70MK2KeyboardLayout(layouts []string, active string) bool {
...
func containsK70MK2KeyboardProfile(profiles []string, active string) bool {
