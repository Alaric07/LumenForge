...
func TestVanguard96WModernWorkspaceSourceConstants(t *testing.T) {
...
func TestVanguard96WFlashTapSnapshotFlattensMultipleRows(t *testing.T) {
	...
	d := &Device{Serial: "wireless", DeviceProfile: &DeviceProfile{Profile: "default", Keyboards: map[string]*keyboards.Keyboard{"default": keyboard}, FlashTap: &keyboards.FlashTap{Active: 1, Mode: 1, Keys: map[int]keyboards.FlashTapKey{0: {Name: "A", KeyData: 4}, 1: {Name: "D", KeyData: 7}}, Color: rgb.Color{}}}, FlashTapModes: map[int]string{0: "Neutral", 1: "Last Priority", 2: "First Priority"}}
