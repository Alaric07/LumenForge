...
func (d *Device) createDevice() {
	d.instance = &common.Device{
		ProductType: common.ProductTypeVanguard99AirWU,
		Product:     d.Product,
		Serial:      d.Serial,
		Firmware:    d.Firmware,
...
func (d *Device) getBatterLevel() {
	...
	d.BatteryLevel = binary.LittleEndian.Uint16(batteryLevel[5:7]) / 10
...
func (d *Device) writeColorCluster(data []byte, _ int) {
	...
	// Control dial
	copy(buf[417:429], d.getControlDialColor())
