...
func (d *Device) KeyboardAssignmentsSnapshot() (keyboardassignmentspresentation.Snapshot, bool) {
	if d == nil || d.DeviceProfile == nil || d.DeviceProfile.Profile == "" || len(d.Layouts) == 0 || d.UIKeyboard == "" || d.UIKeyboardRow == "" || len(d.KeyAssignmentTypes) == 0 || !containsK65RGBRFKeyboardLayout(d.Layouts, d.DeviceProfile.Layout) || !containsK65RGBRFKeyboardProfile(d.DeviceProfile.Profiles, d.DeviceProfile.Profile) {
...
func containsK65RGBRFKeyboardLayout(layouts []string, active string) bool {
...
func containsK65RGBRFKeyboardProfile(profiles []string, active string) bool {
