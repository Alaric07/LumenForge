...
var (
	...
	keyboardKey             = "k60rgbpro-default"
	defaultLayout           = "k60rgbpro-default-US"
	KeyAssignment           = 123
...
func (d *Device) saveDeviceProfile() {
	...
	if d.DeviceProfile == nil {
		...
		deviceProfile.BrightnessLevel = 10
...
func (d *Device) triggerKeyAssignment(value []byte, functionKey bool, modifierKey uint8) {
	...
	if val.Cmp(big.NewInt(0)) > 0 {
		...
		if functionKey {
			...
			case 11: // Brightness +
				if d.DeviceProfile.BrightnessLevel < 10 {
					d.DeviceProfile.BrightnessLevel++
				}
			case 12: // Brightness -
