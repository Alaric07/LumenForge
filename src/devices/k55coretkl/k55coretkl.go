...
var (
	...
	colorPacketLength       = 29
	keyboardKey             = "k55coretkl-default"
	defaultLayout           = "k55coretkl-default-US"
	KeyAssignment           = 125
...
func (d *Device) createDevice() {
	d.instance = &common.Device{
		ProductType: common.ProductTypeK55CoreTkl,
		Product:     d.Product,
		Serial:      d.Serial,
		Firmware:    d.Firmware,
