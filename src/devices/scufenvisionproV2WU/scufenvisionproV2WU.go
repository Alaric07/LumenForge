...
// Package: Corsair SCUF Envision Pro Controller V2
...
func (d *Device) createDevice() {
	d.instance = &common.Device{
		ProductType: common.ProductTypeScufEnvisionProV2WU,
		Product:     d.Product,
		Serial:      d.Serial,
		Firmware:    d.Firmware,
...
// TriggerHapticEngineExternal will trigger vibration motors from external source
...
// getAnalogData will listen for analog events
// ReadWithTimeout is mandatory due to the nature of listening for events
