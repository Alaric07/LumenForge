...
func (d *Device) KeyboardAssignmentsSnapshot() (keyboardassignmentspresentation.Snapshot, bool) {
	if d == nil || d.DeviceProfile == nil || d.DeviceProfile.Profile == "" || len(d.Layouts) == 0 || d.UIKeyboard == "" || d.UIKeyboardRow == "" || len(d.KeyAssignmentTypes) == 0 || !containsk55ProXT(d.Layouts, d.DeviceProfile.Layout) || !containsk55ProXT(d.DeviceProfile.Profiles, d.DeviceProfile.Profile) {
...
func containsk55ProXT(values []string, value string) bool {
