...
// Package: CORSAIR HARPOON RGB PRO Gaming Mouse
...
var (
	...
	cmdWriteColor         = []byte{0x22, 0x01, 0x01}
...
func (d *Device) setupKeyAssignment() {
	...
	// Override Right button and middle button position
	keys[1] = 4
	keys[2] = 2
