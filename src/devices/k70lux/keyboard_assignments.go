...
func (d *Device) KeyboardAssignmentsSnapshot() (keyboardassignmentspresentation.Snapshot, bool) {
	if d == nil || d.DeviceProfile == nil || d.DeviceProfile.Profile == "" || len(d.Layouts) == 0 || d.UIKeyboard == "" || d.UIKeyboardRow == "" || len(d.KeyAssignmentTypes) == 0 || !containsK70LUXKeyboardLayout(d.Layouts, d.DeviceProfile.Layout) || !containsK70LUXKeyboardProfile(d.DeviceProfile.Profiles, d.DeviceProfile.Profile) {
...
func containsK70LUXKeyboardLayout(layouts []string, active string) bool {
...
func containsK70LUXKeyboardProfile(profiles []string, active string) bool {
