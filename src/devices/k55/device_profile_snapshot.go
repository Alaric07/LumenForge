...
func (d *Device) DeviceProfileSnapshot() (deviceprofilepresentation.Snapshot, bool) {
	if d == nil || d.DeviceProfile == nil || d.DeviceProfile.Profile == "" || len(d.UserProfiles) == 0 || !containsk55(d.DeviceProfile.Profiles, d.DeviceProfile.Profile) || d.DeviceProfile.Keyboards == nil || d.DeviceProfile.Keyboards[d.DeviceProfile.Profile] == nil {
