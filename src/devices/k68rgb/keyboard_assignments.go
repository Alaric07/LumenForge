...
func (d *Device) KeyboardAssignmentsSnapshot() (keyboardassignmentspresentation.Snapshot, bool) {
	if d == nil || d.DeviceProfile == nil || d.DeviceProfile.Profile == "" || len(d.Layouts) == 0 || d.UIKeyboard == "" || d.UIKeyboardRow == "" || len(d.KeyAssignmentTypes) == 0 || !containsK68RGBKeyboardLayout(d.Layouts, d.DeviceProfile.Layout) || !containsK68RGBKeyboardProfile(d.DeviceProfile.Profiles, d.DeviceProfile.Profile) {
...
func containsK68RGBKeyboardLayout(layouts []string, active string) bool {
...
func containsK68RGBKeyboardProfile(profiles []string, active string) bool {
