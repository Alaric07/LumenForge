...
var (
	...
	keyboardKey             = "strafergbmk2-default"
	defaultLayout           = "strafergbmk2-default-US"
...
func (d *Device) createDevice() {
	d.instance = &common.Device{
		ProductType: common.ProductTypeStrafeRgbMk2,
		Product:     d.Product,
		Serial:      d.Serial,
		Firmware:    d.Firmware,
