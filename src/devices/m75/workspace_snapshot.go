...
var m75VisibleButtonOrder = []int{1, 2, 4, 8, 16, 32, 64, 128}
...
func (d *Device) ButtonsSnapshot() (buttonspresentation.Snapshot, bool) {
	...
	s := buttonspresentation.Snapshot{Buttons: make([]buttonspresentation.Button, 0, len(m75VisibleButtonOrder))}
	for _, k := range m75VisibleButtonOrder {
...
func m75Options(v map[int]string) []performancepresentation.Option {
...
func (d *Device) PerformanceSnapshot() (performancepresentation.Snapshot, bool) {
	...
	p, b, l := m75Options(d.PollingRates), m75Options(d.SwitchModes), m75Options(d.LiftHeights)
