...
func m75WorkspaceDevice() *Device {
	...
	stages[5] = p
	return &Device{Serial: "m75", MinDPI: 100, MaxDPI: 26000, DPIAmount: 6, KeyAssignment: keys, KeyAssignmentTypes: map[int]string{0: "None", 1: "Media", 2: "DPI", 3: "Keyboard", 8: "Sniper", 9: "Mouse", 10: "Macro", 11: "Profile"}, PollingRates: map[int]string{1: "1000 Hz"}, SwitchModes: map[int]string{1: "Enabled"}, LiftHeights: map[int]string{3: "Medium"}, UserProfiles: map[string]*DeviceProfile{"Default": {Active: true}, "FPS": {}, "nil": nil}, DeviceProfile: &DeviceProfile{Profile: 1, PollingRate: 1, AngleSnapping: 1, ButtonOptimization: 1, LiftHeight: 3, Profiles: stages}}
}
func TestM75WorkspaceSnapshotsFailClosed(t *testing.T) {
	d := m75WorkspaceDevice()
