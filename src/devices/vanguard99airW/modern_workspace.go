...
func (d *Device) KeyboardAssignmentsSnapshot() (keyboardassignmentspresentation.Snapshot, bool) {
	if d == nil || d.DeviceProfile == nil || d.DeviceProfile.Profile == "" || len(d.Layouts) == 0 || d.UIKeyboard == "" || d.UIKeyboardRow == "" || len(d.KeyAssignmentTypes) == 0 || !vanguard99airWContains(d.Layouts, d.DeviceProfile.Layout) || !vanguard99airWContains(d.DeviceProfile.Profiles, d.DeviceProfile.Profile) {
...
func vanguard99airWContains(values []string, value string) bool {
