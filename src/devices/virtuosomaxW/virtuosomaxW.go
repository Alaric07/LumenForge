...
var (
	...
	rgbProfileUpgrade = []string{"gradient", "nebula", "pastelrainbow", "pastelspiralrainbow", "flame", "aurora", "cyberpunkglitch", "tokyonight"}
	rgbModes                  = []string{
		"colorpulse",
		"colorshift",
		"colorwarp",
...
func (d *Device) saveDeviceProfile() {
	...
	if d.DeviceProfile == nil {
		...
		if d.DeviceProfile.Equalizers == nil {
			...
			d.DeviceProfile.Equalizers = deviceProfile.Equalizers
		} else {
