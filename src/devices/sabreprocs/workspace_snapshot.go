...
var sabreProCSVisibleButtonOrder = []int{1, 2, 4, 8, 16, 32}
...
func (d *Device) ButtonsSnapshot() (buttonspresentation.Snapshot, bool) {
	...
	s := buttonspresentation.Snapshot{Buttons: make([]buttonspresentation.Button, 0, len(sabreProCSVisibleButtonOrder))}
	for _, k := range sabreProCSVisibleButtonOrder {
...
func sabreProCSOptions(v map[int]string) []performancepresentation.Option {
