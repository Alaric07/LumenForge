...
func sabreProCSWorkspaceDevice() *Device {
	...
	stages[5] = p
	return &Device{Serial: "sabrecs", MinDPI: 100, MaxDPI: 18000, DPIAmount: 6, KeyAssignment: keys, KeyAssignmentTypes: map[int]string{0: "None", 1: "Media", 2: "DPI", 3: "Keyboard", 8: "Sniper", 9: "Mouse", 10: "Macro", 11: "Profile"}, PollingRates: map[int]string{1: "1000 Hz"}, SwitchModes: map[int]string{1: "Enabled"}, UserProfiles: map[string]*DeviceProfile{"Default": {Active: true}, "FPS": {}, "nil": nil}, DeviceProfile: &DeviceProfile{Profile: 1, PollingRate: 1, AngleSnapping: 1, ButtonOptimization: 1, Profiles: stages}}
}
func TestSabreProCSWorkspaceSnapshotsFailClosed(t *testing.T) {
	d := sabreProCSWorkspaceDevice()
