...
func (d *Device) KeyboardAssignmentsSnapshot() (keyboardassignmentspresentation.Snapshot, bool) {
	if d == nil || d.DeviceProfile == nil || d.DeviceProfile.Profile == "" || len(d.Layouts) == 0 || d.UIKeyboard == "" || d.UIKeyboardRow == "" || len(d.KeyAssignmentTypes) == 0 || !containsK70Core(d.Layouts, d.DeviceProfile.Layout) || !containsK70Core(d.DeviceProfile.Profiles, d.DeviceProfile.Profile) {
...
func containsK70Core(values []string, value string) bool {
