...
var (
	...
	rgbProfileUpgrade     = []string{"arc", "comet", "datastream", "plasmacore", "gradient", "pastelrainbow", "pastelspiralrainbow", "rain", "off", "rotarystack", "flame", "aurora", "cyberpunkglitch", "tokyonight"}
)
